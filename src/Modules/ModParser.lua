...
local modNameList = {
	...
	["culling strike threshold"] = "CullingStrikeThreshold",
...
local specialModList = {
	...
	["arrows gain critical hit chance as they travel farther, up to (%d+)%% increased critical hit chance"] = function(num) return { mod("CritChance", "INC", num, nil, ModFlag.Bow, { type = "DistanceRamp", ramp = { {35,0},{70,1} } }) } end,
	...
	-- Culling
	["culling strike"] = { flag("CullingStrike", { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["culling strike with melee weapons"] = { flag("CullingStrike", nil, ModFlag.WeaponMelee, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["melee weapon attacks have culling strike"] = { flag("CullingStrike", nil, bor(ModFlag.Attack, ModFlag.WeaponMelee), { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["culling strike during f?l?a?s?k? ?effect"] = { flag("CullingStrike", { type = "Condition", var = "UsingFlask" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	...
	["y?o?u?r? ?critical hits have culling strike"] = { flag("CriticalCullingStrike") },
	...
	["nearby allies have culling strike"] = { mod("ExtraAura", "LIST", {onlyAllies = true, mod = flag("CullingStrike")}) },
